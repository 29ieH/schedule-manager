    ...
    <div class="web">
        ...
        <div class="hu-body">
            ...
            <div class="hu-addsk--form">
                ...
                <form id="myForm" action="<c:url value ="/them-su-kien"/>" method="get">
                    <div class="hu-addsk--form-div">
                        <div class="hu-addsk--form-left">
                            <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label">Tên sự kiện</label>
                              <input type="text" class="form-control" id="tenSuKien" aria-describedby="emailHelp" value="<%=tenSuKien%>" name="tenSuKien" onblur="myblur(this.id)">
                              <div id ="error-tenSuKien" class="mess_error"></div>
                            </div>
                            <div class="form-floating mb-3">
                                <textarea class="form-control" placeholder="Leave a comment here" id="moTa" name="moTa"  onblur="myblur(this.id)"><%=moTa%></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="ngay" name="ngay" onblur="myblur(this.id)" value="<%=ngay%>">
                            ...
                            <div class="hu-addsk--time">
                                <div class="mb-3 m-r-20">
                                    ...
                                    <input type="time" class="form-control" id="thoiGianBatDau" name="thoiGianBatDau" onblur="myblur(this.id)" value="<%=tgbd%>">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="time" class="form-control" id="thoiGianKetThuc" name="thoiGianKetThuc" onblur="myblur(this.id)" value="<%=tgkt%>">
                                    <div id="error-thoiGianKetThuc" class="mess_error"></div>
                                </div>
                            </div>
                            <div class="form-floating">
                                <textarea class="form-control" placeholder="Leave a comment here" id="diaDiem" name="diaDiem" onblur="myblur(this.id)"><%=diaDiem%></textarea>
                    ...
                    <div class="hu-addsk--form-right">
                        <div class="mb-3">
                            ...
                            <input list="options" class="form-control" id="henGio" aria-label="Default input example" name="henGio" onblur="myblur(this.id)" value="<%=henGio%>">
                            <datalist id="options">
                              <option>5p</option>
                              <option>10p</option>
                              <option>15p</option>
                        ...
                        <div class="form-floating mb-3">
                            <textarea class="form-control" placeholder="Leave a comment here" id="nguoiThamGia" name="nguoiThamGia" onblur="myblur(this.id)"><%=nguoiThamGia%></textarea>
                        ...
                        <div class="mb-3">
                            <select class="form-select form-control" aria-label="Default select example" id = "loaiSuKien" name="loaiSuKien" onblur="myblur(this.id)">
                            	<%if(loaiSuKien!=""){ %>
                            	<option selected><%=loaiSuKien%></option>
                            	<%} else { %>
                ...
                <button   type="button" class=" hu-addsk--submit " onclick="sendForm()">Thêm</button>
                  </form>
            </div>
        </div>
    </div>
