    ...
    <div class="web">
            ...
            <h6 class="dashboard__heading">Danh sách chức năng</h6>
               <ul class="dashboard__list">
                ...
                <li class="dashboard__item timeline">
                    <a class="dashboard__item--link" href="<c:url value ="/views/indextimeline.jsp"/>">
                        <i class="dashboard__item--icon fa-solid fa-business-time"></i>
                    Thời gian một ngày
                    </a>
        ...
        <div class="hu-body">
            ...
            <div class="hu-sk--content">
                ...
                <p class="sk-body-subsearch">Những sự kiện đã diễn ra trước đây</p>
            ...
            <form action="<c:url value="/dtb-bevent"/>" id="myForm" method="get">
                <div class="sk-body-listevent">
                <c:if test="${list.size()<=0}">
                    <div class="sk-body-listevent--none">
                        <h4 class="sk-body-listevent--none--heading">Bạn chưa thêm sự kiện nào</h4>
                        <p class="sk-body-listevent--sub">Thêm sự kiện của bạn tại đây<a href=""></a></p>
                    </div>
                </c:if>
                <c:if test="${list.size()>0}">
