...
/**
 * Servlet implementation class timelinedelete
 */
public class timelinedelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public timelinedelete() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session!=null) {
			...
			try {
				...
				boolean check = false;
				check = new timelineServiceImp().delete(u, idInt);
				if(check) {
